...
const Admin = ({ match }: AdminProps) => {
  ...
  return (
    <Switch>
      ...
      <Route exact path={`${match.url}/drivers/edit/:name`} component={dashboardRoutes.UserProfile} />
      ...
      <Route path={`${match.url}/cars/new`} component={dashboardRoutes.RegisterTruck} />
      ...
      <Route path={`${match.url}/reports`} component={dashboardRoutes.TripPaymentReport} />
